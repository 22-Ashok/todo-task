      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button 
            ...
            className="px-3 py-1.5 rounded-lg border border-[#2A2A2A] hover:border-[#1D9E75]/40 text-xs font-semibold text-[#bccac1] hover:text-white transition-all bg-[#1A1A1A] cursor-pointer"
          >
            Reload Demo Tasks
          </button>
          <button 
            ...
            className="px-3 py-1.5 rounded-lg border border-red-900/60 hover:border-red-500/40 text-xs font-semibold text-[#ffb4ab]/80 hover:text-red-400 transition-all bg-[#1A1A1A] cursor-pointer"
          >
            Reset State
          </button>
        </div>
