...
export default function AddCategoryModal() {
  const { addCategory, isAddCategoryOpen, setIsAddCategoryOpen } = useTodos();
      ...
      <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded-xl w-full max-w-[420px] flex flex-col shadow-2xl overflow-hidden">
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-5 flex flex-col gap-4">
            ...
            {/* Category Name */}
            <div>
              <label className="block text-xs font-semibold text-[#bccac1] mb-1.5" htmlFor="modal-cat-name">
